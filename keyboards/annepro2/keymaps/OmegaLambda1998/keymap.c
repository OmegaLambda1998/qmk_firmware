...
*/
  ...
  * Layer FN1
  * ,-----------------------------------------------------------------------------------------.
  * | BT1 |  F1 |  F2 |  F3 |  F4 |  F5 |  F6 |  F7 |  F8 |  F9 | F10 | F11 | F12 | BTUNPAIR  |
  * |-----------------------------------------------------------------------------------------+
 ...
 [FN1] = LAYOUT_60_ansi( /* FN1 */
    KC_AP2_BT1,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_AP2_BT_UNPAIR,
  ...
  * Layer FN2
  * ,-----------------------------------------------------------------------------------------.
  * |  ~  | MUTE| VOLD| VOLU| MPRV| MPLY| MNXT| BRID| BRIU| MOD | TOG | BRI- | BRI+ | DELETE  |
  * |-----------------------------------------------------------------------------------------+
  * | Tab    |  q  | UP  |  e  |  r  |  t  |  y  |  u  |  i  |  o  | PS | HOME | END |   \    |
  * |-----------------------------------------------------------------------------------------+
  * | Esc     |LEFT |DOWN |RIGHT|  f  |  g  |LEFT |DOWN | UP  |RIGHT| PGUP|PGDN |    Enter    |
 ...
 [FN2] = LAYOUT_60_ansi( /* FN2 */
    KC_GRV,  KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, KC_BRID, KC_BRIU, KC_AP_RGB_MOD, KC_AP_RGB_TOG, KC_AP_RGB_VAD, KC_AP_RGB_VAI, KC_DEL,
    _______, _______, KC_UP,   _______, _______, _______, _______, _______, _______, _______,       KC_PSCR,       KC_HOME,       KC_END,        _______,
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,       KC_PGUP,       KC_PGDN,       _______,
    _______,          _______, _______, _______, _______, _______, _______, _______, _______,       KC_INS,        KC_DEL,        _______,
